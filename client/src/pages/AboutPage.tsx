...
const timeline = [
  {
    ...
    desc: "Início dos estudos em ADS na PUC-GO e primeiros projetos como freelancer desenvolvendo sites e aplicações web em Goiânia.",
  },
  {
    year: "2025",
    title: "Primeiro SaaS",
    desc: "Desenvolvimento do Júri, software especializado para escritórios de advocacia, focando em automação e gestão de processos.",
  },
  {
    year: "2025",
    title: "Expansão",
    desc: "Criação do LotoMax, ecossistema inteligente para gestão de loterias com foco em lógica de dados e rede de agentes.",
  },
  {
    year: "2026",
    title: "Consolidação",
...
const skills = [
  ...
  { category: "Backend", items: ["Python (Estudo)", "Node.js", "PostgreSQL", "n8n (Automação)"] },
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/PedroAndre0li" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                <Github className="w-4 h-4" />
              </a>
              <a href="www.linkedin.com/in/pedro-nascimento-andreoli-b41a17282" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
